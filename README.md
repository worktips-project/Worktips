...
Portions Copyright (c) 2014-2018 The Worktips Project.   
Portions Copyright (c) 2014-2018 The Monero Project.   
Portions Copyright (c) 2012-2013 The Cryptonote developers.

## Development resources

- Web: https://worktips.xyz/
- Telegram: 
- Mail: 
- GitHub: 
- Discord: 
...
Worktips is a private cryptocurrency based on Monero. 

More information on the project can be found on the website and in the whitepaper.

Worktips is an open source project, and we encourage contributions from anyone with something to offer. 
...
* Clone worktips and checkout most recent release version:
```
...
* If you would like a specific [version/tag](https://github.com/worktips-project/worktips/tags), do a git checkout for that version. eg. 'v2.0.3'. If you dont care about the version and just want binaries from master, skip this step:
...
The project can be built from scratch by following instructions for Linux above. If you are running worktips in a jail you need to add the flag: `allow.sysvipc=1` to your jail configuration, otherwise lmdb will throw the error message: `Failed to open lmdb environment: Function not implemented`.
...
Build worktips: `env DEVELOPER_LOCAL_TOOLS=1 BOOST_ROOT=/usr/local make release-static`
...
* Docker
        ...
        docker build -t worktips .

        # or build using a specific number of cores (reduce RAM requirement)
        docker build --build-arg NPROC=1 -t worktips .

        # either run in foreground
        docker run -it -v /worktips/chain:/root/.worktips -v /worktips/wallet:/wallet -p 22020:22020 worktips

        # or in background
        docker run -it -d -v /worktips/chain:/root/.worktips -v /worktips/wallet:/wallet -p 22020:22020 worktips
